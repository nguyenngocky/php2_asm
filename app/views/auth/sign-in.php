								...
								<div class="m-sm-4">
									...
									<form action="" method="post">
										...
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" type="password" name="password" placeholder="Nhập vào mật khẩu" />
											<small>
										...
										<div>
                                            ...
                                            <label for="form">
                                                <a href="<?= BASE_URL. 'sign-up'?>">Bạn chưa có tài khoản ? Đăng ký ngay</a>
                                            </label>
										</div>
