								...
								<div class="m-sm-4">
									<form action="<?= BASE_URL . 'sign-up/luu'?>" method="POST">
                                        ...
                                        <div class="mb-3">
											...
											<input class="form-control form-control-lg" type="password" name="repassword" placeholder="Nhập lại mật khẩu" />
										</div>
										<a href="<?= BASE_URL. 'login'?>">Bạn đã có tài khoản ? đăng nhập ngay</a>
